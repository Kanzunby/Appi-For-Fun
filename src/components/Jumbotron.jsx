...
const Jumbotron = ({fetchData}) => {
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-center py-20 px-2">
      ...
      <div className="flex items-center mt-6 max-w-md mx-auto bg-white  rounded-full">
        <input 
        type="search"
        className="w-full px-4 py-2 rounded-full text-gray-800 focus: outline-none "
        placeholder="Mau cari apa Bang"
        value={value}
        onChange={e => setValue(e.target.value)}
        onKeyDown={handleEnter}
        />
        <button className="bg-blue-500 hover:bg-blue-600  w-20 h-12 text-white rounded-r-full flex items-center justify-center"
        onClick={hadleButtonSearch}
        >
